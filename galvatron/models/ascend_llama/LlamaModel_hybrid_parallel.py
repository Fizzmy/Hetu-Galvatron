...
from galvatron.models.ascend_llama.LlamaModel_sequential import LlamaModelInfo, construct_sequential_model
from galvatron.models.ascend_llama.LlamaModel_tensor_parallel import construct_tensor_parallel_model, LlamaLayer_tp
