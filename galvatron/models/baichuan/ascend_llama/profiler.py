...
from galvatron.models.ascend_llama.arguments import model_args, layernum_arg_names
from galvatron.models.ascend_llama.meta_configs import config_from_meta, set_model_config, model_name
import os
